...
export default function DeliveryDetail() {
    ...
    return (
      <AppLayout>
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-muted-foreground mb-4">The delivery order you're looking for doesn't exist.</p>
          <Button onClick={() => navigate("/operations/deliveries")}>
  ...
  const totalValue = delivery.lines.reduce((sum, line) => sum + (line.quantity * (line.unitPrice || 0)), 0);
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">{delivery.referenceNo}</h1>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold">{delivery.warehouseName}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold">{delivery.lines.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {delivery.notes && (
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground whitespace-pre-wrap">{delivery.notes}</p>
              </CardContent>
            </Card>
          )}
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {format(new Date(delivery.updatedAt), "MMM dd, yyyy HH:mm")}
                </span>
              </div>
              <div className="flex justify-between">
